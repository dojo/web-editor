...
if (!has('url-api')) {
	(function () {
		const relative: { [protocol: string]: number; } = Object.create(null);
		relative['ftp'] = 21;
		relative['file'] = 0;
		relative['gopher'] = 70;
		relative['http'] = 80;
		...
		function invalid(this: any) {
			clear.call(this);
			this._isInvalid = true;
		}

		function IDNAToASCII(this: any, h: string) {
			if ('' === h) {
				invalid.call(this);
			}
			// XXX
		...
		function parse(this: any, input: string, stateOverride: string, base: any) {
		...
		function jURL(this: any, url: any, base: any /* , encoding */): void {
			if (base !== undefined && !(base instanceof jURL)) {
				base = new (jURL as any)(String(base));
			}
		...
		if (OriginalURL) {
			(jURL as any).createObjectURL = function(blob: any) {
				// IE extension allows a second optional options argument.
				// http://msdn.microsoft.com/en-us/library/ie/hh772302(v=vs.85).aspx
				return OriginalURL.createObjectURL.apply(OriginalURL, arguments);
			};
			(jURL as any).revokeObjectURL = function(url: any) {
