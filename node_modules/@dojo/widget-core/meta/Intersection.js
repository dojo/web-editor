...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/shim/global", "@dojo/shim/WeakMap", "@dojo/shim/Map", "@dojo/core/lang", "./Base", "intersection-observer"], factory);
    }
    ...
    var Intersection = (function (_super) {
            ...
            _this._onIntersect = function (detailEntries) {
                return function (entries) {
                    for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
                        var _a = entries_1[_i], intersectionRatio = _a.intersectionRatio, isIntersecting = _a.isIntersecting, target = _a.target;
        ...
        Intersection.prototype._createDetails = function (options, rootNode) {
            ...
            var observer = new global_1.default.IntersectionObserver(this._onIntersect(entries), __assign({}, options, { root: rootNode }));
            var details = __assign({ observer: observer, entries: entries }, options);
