(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/shim/global", "@dojo/shim/WeakMap", "@dojo/shim/Map", "@dojo/core/lang", "./Base", "intersection-observer"], factory);
    }
    ...
    var Intersection = /** @class */ (function (_super) {
        ...
        Intersection.prototype._createDetails = function (options, rootNode) {
            ...
            this.own(lang_1.createHandle(observer.disconnect));
            return details;
        };
