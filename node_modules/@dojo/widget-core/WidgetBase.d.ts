...
import { DNode, HNode, PropertiesChangeEvent, VirtualDomNode, WidgetMetaConstructor, WidgetBaseInterface, WidgetProperties, WNode } from './interfaces';
...
export declare class WidgetBase<P extends WidgetProperties = WidgetProperties, C extends DNode = DNode> extends Evented implements WidgetBaseInterface<P, C> {
    ...
    private _setNode(element, properties);
    readonly properties: Readonly<P>;
    __setProperties__(originalProperties: P): void;
     ...
     */
    private _bindFunctionProperties(properties, bind);
     ...
     */
    private _runAfterRenders(dNode);
    /**
