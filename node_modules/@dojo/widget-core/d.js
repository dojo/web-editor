(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/lang", "@dojo/shim/Symbol", "maquette", "./WidgetRegistry"], factory);
    }
     ...
     */
    exports.registry = new WidgetRegistry_1.WidgetRegistry();
    /**
    ...
    function v(tag, propertiesOrChildren, children) {
        ...
        return {
            ...
            properties: properties,
            render: function () {
                return maquette_1.h(tag, this.properties, this.vNodes);
            },
            type: exports.HNODE
        };
    }
