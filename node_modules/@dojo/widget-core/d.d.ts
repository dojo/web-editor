import { Constructor, DefaultWidgetBaseInterface, DNode, HNode, RegistryLabel, VirtualDomProperties, WidgetBaseInterface, WNode } from './interfaces';
 ...
 */
export declare const registry: WidgetRegistry;
/**
 ...
 */
export declare function v(tag: string, properties: VirtualDomProperties, children?: DNode[]): HNode;
