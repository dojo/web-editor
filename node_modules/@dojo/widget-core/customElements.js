(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/lang", "@dojo/shim/array", "@dojo/shim/global", "./d", "./mixins/Projector", "./util/DomWrapper"], factory);
    }
    ...
    function initializeElement(element) {
        ...
        array_1.from(element.children).forEach(function (childNode, index) {
            var DomElement = DomWrapper_1.default(childNode);
            children.push(d_1.w(DomElement, {
                key: "child-" + index
            }));
        });
        if (initialization) {
