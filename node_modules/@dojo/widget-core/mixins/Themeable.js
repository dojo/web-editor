...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/lang", "@dojo/core/Evented", "@dojo/shim/array", "@dojo/shim/Map", "./../d", "./../Injector", "./../WidgetBase"], factory);
    }
     ...
     */
    var ThemeInjectorContext = (function (_super) {
        __extends(ThemeInjectorContext, _super);
        /**
         * @param theme optional theme to initialize the context
         */
        function ThemeInjectorContext(theme) {
         ...
         */
        ThemeInjectorContext.prototype.set = function (theme) {
            this._theme = theme;
            this.emit({ type: 'invalidate' });
        };
        Object.defineProperty(ThemeInjectorContext.prototype, "theme", {
            /**
    ...
    exports.ThemeInjectorContext = ThemeInjectorContext;
    /**
     ...
     * injected.
     */
    var ThemeInjector = (function (_super) {
        __extends(ThemeInjector, _super);
        function ThemeInjector(context) {
            var _this = _super.call(this, context) || this;
            _this.own(context.on('invalidate', _this.invalidate.bind(_this)));
            return _this;
        }
        return ThemeInjector;
    }(Injector_1.BaseInjector));
    ...
    function registerThemeInjector(theme, themeRegistry) {
        if (themeRegistry === void 0) { themeRegistry = d_1.registry; }
        var themeInjectorContext = new ThemeInjectorContext(theme);
        var ThemeInjectorBase = Injector_1.Injector(ThemeInjector, themeInjectorContext);
        themeRegistry.define(exports.INJECTED_THEME_KEY, ThemeInjectorBase);
        return themeInjectorContext;
    }
    ...
    function ThemeableMixin(base) {
        var Themeable = (function (_super) {
            ...
            Themeable.prototype.injectTheme = function (renderFunc, properties, children) {
                var _this = this;
                return function () {
                    var hasInjectedTheme = _this.registries.has(exports.INJECTED_THEME_KEY);
                    if (hasInjectedTheme) {
                        return d_1.w(exports.INJECTED_THEME_KEY, {
                            bind: _this,
                            render: renderFunc,
                            getProperties: function (inject, properties) {
                                if (!properties.theme && _this._theme !== properties.injectedTheme) {
                                    _this._recalculateClasses = true;
                                }
