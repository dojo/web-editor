...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/lang", "@dojo/i18n/i18n", "./../WidgetBase", "./../d"], factory);
    }
    ...
    function I18nMixin(base) {
        var I18n = (function (_super) {
            ...
            I18n.prototype.localizeBundle = function (bundle) {
                ...
                var messages = this.getLocaleMessages(bundle) || bundle.messages;
            ...
            I18n.prototype.renderDecorator = function (result) {
                if (d_1.isHNode(result)) {
                    ...
                    lang_1.assign(result.properties, vNodeProperties);
                }
                return result;
            };
            /**
             ...
             */
            I18n.prototype.getLocaleMessages = function (bundle) {
                var _this = this;
