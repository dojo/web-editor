...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/Evented", "@dojo/shim/Map", "@dojo/shim/Set", "@dojo/shim/WeakMap", "./d", "./diff", "./WidgetRegistry", "./RegistryHandler"], factory);
    }
    ...
    var WidgetBase = WidgetBase_1 = (function (_super) {
         ...
         */
        WidgetBase.prototype.bindFunctionProperties = function (properties, bind) {
            var _this = this;
        ...
        WidgetBase.prototype.dNodeToVNode = function (dNode) {
            ...
            if (Array.isArray(dNode)) {
                return dNode.map(function (node) { return _this.dNodeToVNode(node); });
            }
