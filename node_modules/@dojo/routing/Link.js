(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/widget-core/WidgetBase", "@dojo/widget-core/d", "@dojo/widget-core/decorators/inject", "./RouterInjector"], factory);
    }
    ...
    var getProperties = function (router, properties) {
        ...
        var href = isOutlet ? router.link(to, tslib_1.__assign({}, router.getCurrentParams(), params)) : to;
    ...
    var BaseLink = /** @class */ (function (_super) {
        ...
        BaseLink.prototype.render = function () {
            ...
            return d_1.v('a', tslib_1.__assign({}, props), this.children);
        };
        return BaseLink;
