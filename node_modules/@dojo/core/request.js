(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/has/has", "./async/Task", "./request/ProviderRegistry", "./request/providers/xhr", "./request/Headers", "./request/TimeoutError", "./request/Response"], factory);
    }
    ...
    if (has_1.default('host-node')) {
        var nodeProvider = require('./request/providers/node').default;
    ...
    var Response_1 = require("./request/Response");
