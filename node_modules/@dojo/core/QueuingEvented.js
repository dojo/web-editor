...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/shim/Map", "./Evented"], factory);
    }
     ...
     */
    var QueuingEvented = (function (_super) {
        __extends(QueuingEvented, _super);
        function QueuingEvented() {
            var _this = _super.call(this) || this;
            _this.maxEvents = 0;
            _this._queue = new Map_1.default();
            _this._originalOn = _this.on;
            _this.on = function () {
                var _this = this;
                var args = [];
                ...
                var handle = this._originalOn.apply(this, args);
