(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/shim/object", "@dojo/shim/object", "@dojo/shim/Set"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var object_1 = require("@dojo/shim/object");
    var object_2 = require("@dojo/shim/object");
    ...
    function diffArray(a, b, options) {
        ...
        arrayA.forEach(function (valueA, index) {
            ...
            if (isValueAArray || isValueAPlainObject) {
                var value = isValueAArray ? isArray(valueB) ? valueB : [] : isPlainObject(valueB) ? valueB : Object.create(null);
    ...
    function getComparableObjects(a, b, options) {
        ...
        var isIgnoredProperty = Array.isArray(ignoreProperties) ? function (name) {
    ...
    function isIgnoredPropertyValue(name, a, b, ignoredPropertyValues) {
        return Array.isArray(ignoredPropertyValues) ? ignoredPropertyValues.some(function (value) {
    ...
    function patchSplice(target, _a) {
        ...
        if (add && add.length) {
            ...
            target.splice.apply(target, [start, deleteCount].concat(add));
        }
        else {
    ...
    function patchConstruct(target, record) {
        ...
        var value = new (Ctor.bind.apply(Ctor, [void 0].concat((args || []))))();
        if (propertyRecords) {
    ...
    function resolveTargetValue(patchValue, targetValue) {
        ...
        return (patchIsSpliceRecordArray || isPatchRecordArray(patchValue)) ?
            patch(patchIsSpliceRecordArray ?
                ...
                targetValue : objectCreate(null), patchValue) :
            patchValue;
    }
    /**
