...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/shim/Set", "@dojo/shim/WeakMap", "http", "https", "url", "zlib", "../../async/Task", "../../lang", "../../queue", "../../util", "../Headers", "../Response", "../TimeoutError", "../../Observable", "../SubscriptionPool"], factory);
    }
     ...
     */
    var NodeResponse = (function (_super) {
        __extends(NodeResponse, _super);
        function NodeResponse(response) {
            ...
            var _loop_1 = function (key) {
                if (discardedDuplicates.has(key)) {
                    ...
                    var values = response.headers[key].split(', ');
                ...
                var task = new Task_1.default(function (resolve, reject) {
                    ...
                    queue_1.queueTask(function () {
                        ...
                        message.once('end', function () {
                            ...
                            var dataAsBuffer = (options.streamEncoding ? new Buffer(data.buffer.join(''), 'utf8') : Buffer.concat(data.buffer, data.size));
