(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/shim/global", "@dojo/shim/WeakMap", "../../async/Task", "../../has", "../../Observable", "../../util", "../Headers", "../Response", "../SubscriptionPool", "../TimeoutError", "../util"], factory);
    }
        ...
        if (options.headers) {
            ...
            try {
                for (var requestHeaders_1 = tslib_1.__values(requestHeaders), requestHeaders_1_1 = requestHeaders_1.next(); !requestHeaders_1_1.done; requestHeaders_1_1 = requestHeaders_1.next()) {
                    var _b = tslib_1.__read(requestHeaders_1_1.value, 2), key = _b[0], value = _b[1];
                ...
                try {
                    if (requestHeaders_1_1 && !requestHeaders_1_1.done && (_c = requestHeaders_1.return)) _c.call(requestHeaders_1);
                }
