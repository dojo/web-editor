...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/widget-core/WidgetBase", "@dojo/widget-core/mixins/Themeable", "../label/Label", "@dojo/widget-core/d", "./styles/checkbox.m.css"], factory);
    }
    ...
    ;
    exports.CheckboxBase = Themeable_1.ThemeableMixin(WidgetBase_1.WidgetBase);
    var Checkbox = (function (_super) {
        __extends(Checkbox, _super);
        function Checkbox() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        Checkbox.prototype._onBlur = function (event) { this.properties.onBlur && this.properties.onBlur(event); };
        ...
        Checkbox.prototype._onFocus = function (event) { this.properties.onFocus && this.properties.onFocus(event); };
        ...
        Checkbox.prototype.render = function () {
            var _a = this.properties, _b = _a.checked, checked = _b === void 0 ? false : _b, describedBy = _a.describedBy, disabled = _a.disabled, formId = _a.formId, invalid = _a.invalid, label = _a.label, mode = _a.mode, name = _a.name, offLabel = _a.offLabel, onLabel = _a.onLabel, readOnly = _a.readOnly, required = _a.required, value = _a.value;
            var stateClasses = [
            ...
            var children = [
                d_1.v('div', { classes: this.classes(css.inputWrapper) }, [
                    mode === 1 /* toggle */ ? d_1.v('div', { classes: this.classes(css.onLabel) }, [onLabel || null]) : null,
                    mode === 1 /* toggle */ ? d_1.v('div', { classes: this.classes(css.offLabel) }, [offLabel || null]) : null,
                    d_1.v('input', {
