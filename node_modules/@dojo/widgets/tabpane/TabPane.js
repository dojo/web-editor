...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/lang", "@dojo/widget-core/mixins/Themeable", "@dojo/widget-core/d", "@dojo/widget-core/WidgetBase", "./TabButton", "@dojo/core/uuid", "./styles/tabPane.m.css"], factory);
    }
    ...
    var css = require("./styles/tabPane.m.css");
    ;
    ;
    exports.TabPaneBase = Themeable_1.ThemeableMixin(WidgetBase_1.WidgetBase);
    var TabPane = (function (_super) {
        ...
        Object.defineProperty(TabPane.prototype, "_tabs", {
            get: function () {
        ...
        TabPane.prototype._onDownArrowPress = function () {
            var alignButtons = this.properties.alignButtons;
            if (alignButtons === 1 /* left */ || alignButtons === 2 /* right */) {
                this.selectNextIndex();
            }
        };
        TabPane.prototype._onLeftArrowPress = function () {
            this.selectPreviousIndex();
        };
        TabPane.prototype._onRightArrowPress = function () {
            this.selectNextIndex();
        };
        TabPane.prototype._onUpArrowPress = function () {
            var alignButtons = this.properties.alignButtons;
            if (alignButtons === 1 /* left */ || alignButtons === 2 /* right */) {
                this.selectPreviousIndex();
            }
        };
        TabPane.prototype._renderTabButtons = function () {
            var _this = this;
        ...
        TabPane.prototype._renderTabs = function () {
            var _this = this;
         ...
         */
        TabPane.prototype._validateIndex = function (currentIndex, backwards) {
            var tabs = this._tabs;
        ...
        TabPane.prototype.closeIndex = function (index) {
        ...
        TabPane.prototype.selectFirstIndex = function () {
            this.selectIndex(0, true);
        };
        TabPane.prototype.selectIndex = function (index, backwards) {
        ...
        TabPane.prototype.selectLastIndex = function () {
            this.selectIndex(this._tabs.length - 1);
        };
        TabPane.prototype.selectNextIndex = function () {
            var activeIndex = this.properties.activeIndex;
            this.selectIndex(activeIndex === this._tabs.length - 1 ? 0 : activeIndex + 1);
        };
        TabPane.prototype.selectPreviousIndex = function () {
            var activeIndex = this.properties.activeIndex;
        ...
        TabPane.prototype.render = function () {
            ...
            return d_1.v('div', {
                ...
                classes: this.classes(alignClass ? alignClass : null, css.root),
                role: 'tablist'
            }, children);
        };
        return TabPane;
