...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/widget-core/WidgetBase", "@dojo/widget-core/mixins/Themeable", "@dojo/widget-core/d", "../label/Label", "./styles/textarea.m.css"], factory);
    }
    ...
    exports.TextareaBase = Themeable_1.ThemeableMixin(WidgetBase_1.WidgetBase);
    var Textarea = (function (_super) {
        ...
        Textarea.prototype.render = function () {
            var _a = this.properties, columns = _a.columns, describedBy = _a.describedBy, disabled = _a.disabled, formId = _a.formId, invalid = _a.invalid, label = _a.label, maxLength = _a.maxLength, minLength = _a.minLength, name = _a.name, placeholder = _a.placeholder, readOnly = _a.readOnly, required = _a.required, rows = _a.rows, value = _a.value, wrapText = _a.wrapText;
            var stateClasses = [
            ...
            var textarea = d_1.v('div', { classes: this.classes(css.inputWrapper) }, [
                d_1.v('textarea', {
