...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/widget-core/mixins/Themeable", "@dojo/widget-core/d", "@dojo/widget-core/WidgetBase", "../common/styles/animations.m.css", "./styles/slidePane.m.css"], factory);
    }
    ...
    var SlidePane = (function (_super) {
        ...
        SlidePane.prototype.render = function () {
            var _a = this.properties, _b = _a.align, align = _b === void 0 ? 0 /* left */ : _b, onOpen = _a.onOpen, _c = _a.open, open = _c === void 0 ? false : _c, _d = _a.underlay, underlay = _d === void 0 ? false : _d, _e = _a.width, width = _e === void 0 ? DEFAULT_WIDTH : _e;
            var contentClasses = [
                css.content,
            ...
            return d_1.v('div', {
                ...
                d_1.v('div', {
                    key: 'content',
                    classes: this.classes.apply(this, contentClasses),
