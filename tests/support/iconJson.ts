const iconCss = {
	'iconDefinitions': {
		...
		'_folder_js': {
			'iconPath': './../../icons/folder-js.svg'
		},
		'_folder_js_open': {
			'iconPath': './../../icons/folder-js-open.svg'
		},
		'_folder_css': {
	...
	'fileExtensions': {
		...
		'bat': '_file_console',
		'cmd': '_file_console',
		'ps1': '_file_powershell',
		'psm1': '_file_powershell',
		'psd1': '_file_powershell',
		'ps1xml': '_file_powershell',
		'psc1': '_file_powershell',
		'pssc': '_file_powershell',
		'gradle': '_file_gradle',
		'doc': '_file_word',
		'docx': '_file_word',
		'rtf': '_file_word',
		...
		'pm': '_file_perl',
		'hx': '_file_haxe',
		'mustache': '_file_handlebars',
		'spec.ts': '_file_test_ts',
		'test.ts': '_file_test_ts',
		'spec.js': '_file_test_js',
		'test.js': '_file_test_js',
		...
		'jl': '_file_julia',
		'elm': '_file_elm',
		'pure': '_file_purescript',
		'tpl': '_file_smarty',
		'styl': '_file_stylus',
		're': '_file_reason',
		'rei': '_file_reason',
		'cmj': '_file_bucklescript',
		'merlin': '_file_merlin',
		'v': '_file_verilog',
		'vhd': '_file_verilog',
		'nb': '_file_mathematica',
		'wl': '_file_wolframlang',
		'wls': '_file_wolframlang',
		'njk': '_file_nunjucks',
		...
		'blade.php': '_file_laravel',
		'applescript': '_file_applescript',
		'cake': '_file_cake',
		'feature': '_file_cucumber',
		'nim': '_file_nim',
		'nimble': '_file_nim',
		'rmd': '_file_r',
		'ng-template': '_file_angular',
		'apib': '_file_apiblueprint',
		'apiblueprint': '_file_apiblueprint',
		'tag': '_file_riot'
	},
	'fileNames': {
		'webpack.js': '_file_webpack',
		'webpack.ts': '_file_webpack',
		'webpack.base.js': '_file_webpack',
		'webpack.base.ts': '_file_webpack',
		...
		'webpack.test.js': '_file_webpack',
		'webpack.test.ts': '_file_webpack',
		...
		'karma.conf.js': '_file_karma',
		'karma.conf.ts': '_file_karma',
		'karma.conf.coffee': '_file_karma',
		'karma.config.js': '_file_karma',
		'karma.config.ts': '_file_karma',
		'karma-main.js': '_file_karma',
		'karma-main.ts': '_file_karma',
		'.bithoundrc': '_file_bithound',
		'appveyor.yml': '_file_appveyor',
		'.travis.yml': '_file_travis',
		'protractor.conf.js': '_file_protractor',
		'protractor.conf.ts': '_file_protractor',
		'protractor.conf.coffee': '_file_protractor',
		'protractor.config.js': '_file_protractor',
		'protractor.config.ts': '_file_protractor',
		'fuse.js': '_file_fusebox',
		'procfile': '_file_heroku',
