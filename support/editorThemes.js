...
(function (factory) {
    ...
    function getEditorTheme(theme) {
        var base = theme.type === 'dark' ? 'vs-dark' : theme.type === 'hc' ? 'hc-black' : 'vs';
        var colors = theme.colors, rules = theme.rules;
        return {
            base: base,
            inherit: true,
            rules: rules,
    ...
    function load(filename) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadThemeFile(filename)];
                    case 1:
                        theme = _a.sent();
...
//# sourceMappingURL=editorThemes.js.map