...
(function (factory) {
    ...
    has_1.add('url-api', function () {
        try {
            var u = new global_1.default.window.URL('b', 'http://a');
            u.pathname = 'c%20d';
            return u.href === 'http://a/c%20d';
        }
        catch (e) { }
    });
    if (!has_1.default('url-api')) {
        (function () {
            ...
            var OriginalURL = global_1.default.URL;
            if (OriginalURL) {
            ...
            global_1.default.window.URL = jURL;
        })();
    }
});
